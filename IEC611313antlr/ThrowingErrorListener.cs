...
namespace AIS.VariantMngt.IEC611313antlr
{
    public class ThrowingErrorListener : BaseErrorListener, IAntlrErrorListener<int>
    {
                                            ...
                                            RecognitionException e)
        {
            if (e != null)
            {
                Debug.WriteLine("Error in parser at line " + ": " + e.OffendingToken.Line + " Position: " + e.OffendingToken.Column + " " + e.Message);
            }
            else
            {
        ...
        public void SyntaxError(IRecognizer recognizer,
            ...
            RecognitionException e)
        {
            Debug.WriteLine("Error in lexer at line " + ":" + e.OffendingToken.Column + e.OffendingToken.Line + e.Message);
        }
    }
}
